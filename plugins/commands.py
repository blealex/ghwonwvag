...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[           
            InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url=f'https://t.me/SELECT10TV')
            ],[
            InlineKeyboardButton('🔞 BACKUP CHANNEL 🔞', url="https://t.me/JUVENILETIDES_X")
            ]]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("🍿 UᎮDΛTΞS 🍿", url="https://t.me/JUVENILETIDES_X")
            ],[
